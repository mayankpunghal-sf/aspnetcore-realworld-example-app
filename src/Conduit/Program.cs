...
// the database provider and connection string are resolved once, at startup, into a typed
// value; nothing else in the application inspects the provider
var database = DatabaseProviderSelection.Resolve(builder.Configuration);
